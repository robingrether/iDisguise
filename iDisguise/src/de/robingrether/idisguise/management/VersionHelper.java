...
public class VersionHelper {
	...
	private static final String[] versions = {"v1_5_R2", "v1_5_R3", "v1_6_R1", "v1_6_R2", "v1_6_R3", "v1_7_R1", "v1_7_R2", "v1_7_R3", "v1_7_R4", "v1_8_R1", "v1_8_R2", "v1_8_R3"};
	...
	public static boolean init() {
		...
		switch(versionCode) {
			...
			case "v1_6_R3":
				...
				GhostFactory.instance = new de.robingrether.idisguise.management.impl.v1_6_R3.GhostFactoryImpl();
			...
			case "v1_6_R2":
				...
				GhostFactory.instance = new de.robingrether.idisguise.management.impl.v1_6_R2.GhostFactoryImpl();
			...
			case "v1_6_R1":
				...
				GhostFactory.instance = new de.robingrether.idisguise.management.impl.v1_6_R1.GhostFactoryImpl();
