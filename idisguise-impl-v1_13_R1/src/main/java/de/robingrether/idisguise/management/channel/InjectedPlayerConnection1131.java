...
import net.minecraft.server.v1_13_R1.PacketPlayInTeleportAccept;
import net.minecraft.server.v1_13_R1.PacketPlayInUseEntity;
import net.minecraft.server.v1_13_R1.PlayerConnection;

public class InjectedPlayerConnection1131 extends PlayerConnection implements InjectedPlayerConnection {
	
	private final Player observer;
	
	public InjectedPlayerConnection1131(Player observer, Object originalConnection) throws Exception {
