...
public class Language {
	...
	public String HELP_INFO_NEW = ChatColor.GREEN + "%name% %version% - Help %page%/%total%";
	...
	public String HELP_TARGET_UID = ChatColor.GRAY + " <xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx> - Select a player by account id";
	public String HELP_TARGET_EID = ChatColor.GRAY + " [entity-id] - Select an entity/player by entity id";
	public String HELP_TARGET_VANILLA = ChatColor.GRAY + "@p/@r/@a/@e/@s[...] - Select entities/players with vanilla selector";
	public String HELP_TARGET_NAME_EXACT = ChatColor.GRAY + " {player-name} - Select a player by EXACT account name";
	public String HELP_TARGET_NAME_MATCH = ChatColor.GRAY + " player-name - Match an ONLINE player";
